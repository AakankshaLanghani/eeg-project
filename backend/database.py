...
def verify_password(plain: str, hashed: str) -> bool:
    try:
        ...
        return plain == hashed  # fallback for legacy plain-text passwords
...
def _seed(conn):
    ...
    users = [
        ("dr.aakanksha@hospital.com", hash_password("password"), "Doctor",  "Dr. Aakanksha"),
        ("asra@hospital.com",         hash_password("password"), "Patient", "Asra"),
        ("fatima@hospital.com",       hash_password("password"), "Patient", "Fatima Malik"),
        ("usman@hospital.com",        hash_password("password"), "Patient", "Usman Khan"),
        ("sanjana@hospital.com",      hash_password("admin123"), "Admin",   "Sanjana"),
    ]
    conn.executemany(
